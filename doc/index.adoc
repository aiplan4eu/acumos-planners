...
installed, you can also start <<Docker_version>>, which contains them all.

=== Run

If you do not want to run the server locally, skip this step and start <<Docker_version>>.
